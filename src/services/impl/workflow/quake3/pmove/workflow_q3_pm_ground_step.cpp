...
#include "services/interfaces/workflow/quake3/pmove/q3_pm_tuning.hpp"
#include "services/interfaces/workflow/quake3/pmove/q3_pmove.hpp"
...
void WorkflowQ3PmGroundStep::Execute(const WorkflowStepDefinition& step,
    ...
    q3::PmGroundTrace(
        ...
        PlayerBody(context), Q3TuningOf(step));
