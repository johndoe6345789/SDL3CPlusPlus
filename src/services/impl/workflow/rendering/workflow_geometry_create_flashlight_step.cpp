...
void WorkflowGeometryCreateFlashlightStep::Execute(
    ...
    const FlashlightMesh mesh =
        BuildFlashlightMesh(segments, body_radius, body_length, head_radius,
                            head_length, lens_radius);
    ...
    context.Set("plane_" + name, nlohmann::json{{"vertex_count", vertex_count},
