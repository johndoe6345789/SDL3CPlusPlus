...
void WorkflowRegistrar::RegisterSteps(
    ...
    registry->RegisterStep(
        std::make_shared<WorkflowSdlWindowCreateStep>(logger_));
    count += 2;

    // ── GPU initialization ─────────────────────────────────────
    registry->RegisterStep(
        std::make_shared<WorkflowGraphicsInitViewportStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowGraphicsInitRendererStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowGraphicsGpuInitStep>(logger_, nullptr));
    count += 3;

    // ── Graphics pipeline ──────────────────────────────────────
    registry->RegisterStep(
        std::make_shared<WorkflowGeometryCreateCubeStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowGpuShaderCompileStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowGpuPipelineCreateStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowGraphicsBufferCreateVertexStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowGraphicsBufferCreateIndexStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowGraphicsDrawSubmitStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowGraphicsFrameBeginStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowGraphicsFrameEndStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowGraphicsScreenshotRequestStep>(logger_));
    count += 9;

    // ── Rendering ──────────────────────────────────────────────
    registry->RegisterStep(
        std::make_shared<WorkflowRenderGridSetupStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowRenderGridDrawStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowFrameBeginGpuStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowFrameDrawBodiesStep>(logger_));
    ...
    registry->RegisterStep(
        std::make_shared<WorkflowDrawTexturedBoxStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowLightingSetupStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowSpotlightSetupStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowSpotlightUpdateStep>(logger_));
    registry->RegisterStep(std::make_shared<WorkflowModelLoadStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowDrawViewmodelStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowGeometryCreateFlashlightStep>(logger_));
    ...
    registry->RegisterStep(
        std::make_shared<WorkflowBspLightmapAtlasStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowBspParseSpawnStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowBspEntityUpdateStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowBspPortalViewStep>(logger_));
    // bsp.build_geometry split into atomic steps; chain them in this order.
    registry->RegisterStep(
        std::make_shared<WorkflowBspTessellatePatchesStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowBspBuildPolygonsStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowBspFlattenGeometryStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowBspExtractTexturesStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowBspUploadGeometryStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowBspBuildCollisionStep>(logger_));
    ...
    registry->RegisterStep(
        std::make_shared<WorkflowRenderPrepareStep>(logger_));
    registry->RegisterStep(std::make_shared<WorkflowPostfxSetupStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowFrameBeginOffscreenStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowFrameEndSceneStep>(logger_));
    // postfx.composite split into atomic steps; chain them in this order.
    registry->RegisterStep(
        std::make_shared<WorkflowPostfxCompositeDrawStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowPostfxOverlayFpsInitStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowPostfxOverlayFpsUploadQuadStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowPostfxOverlayFpsUploadTextStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowPostfxOverlayFpsDrawStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowGpuScreenshotCaptureStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowGpuCommandBufferSubmitStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowPostfxCompositeFinishStep>(logger_));
    // overlay.fps split into atomic steps; chain them in this order.
    registry->RegisterStep(
        std::make_shared<WorkflowOverlayFpsInitStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowOverlayFpsUploadQuadStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowOverlayFpsUploadTextStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowOverlayFpsDrawStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowDebugScreenshotStep>(logger_));
    registry->RegisterStep(std::make_shared<WorkflowPostfxSsaoStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowPostfxBloomExtractStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowPostfxBloomBlurStep>(logger_));
    registry->RegisterStep(std::make_shared<WorkflowQ3MenuUpdateStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowQ3WeaponUpdateStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowQ3PickupsDrawStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowOverlaySwBeginStep>(logger_));
    ...
    registry->RegisterStep(
        std::make_shared<WorkflowOverlaySwEndInitStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowOverlaySwEndUploadSurfaceStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowOverlaySwEndUploadQuadStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowOverlaySwEndDrawStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowOverlaySwEndBlitHeadStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowOverlaySwEndScreenshotStep>(logger_));
    ...
    registry->RegisterStep(
        std::make_shared<WorkflowQ3Md3ParseTagsStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowQ3Md3ParseAnimStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowQ3Md3UploadSurfacesStep>(logger_));
    ...
    registry->RegisterStep(
        std::make_shared<WorkflowQ3PmStepSlideStep>(logger_));
    ...
    registry->RegisterStep(std::make_shared<WorkflowQ3MusicStep>(logger_));
    registry->RegisterStep(std::make_shared<WorkflowQ3StatsInitStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowQ3PlayerCommitStep>(logger_));
    ...
    registry->RegisterStep(
        std::make_shared<WorkflowQ3PmAccelerateStep>(logger_));
    registry->RegisterStep(std::make_shared<WorkflowQ3PmJumpStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowQ3PmSlideMoveStep>(logger_));
    // Q3 weapons + missiles
    registry->RegisterStep(
        std::make_shared<WorkflowQ3WeaponSelectStep>(logger_));
    registry->RegisterStep(std::make_shared<WorkflowQ3WeaponFireStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowQ3MissilesMoveStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowQ3MissilesImpactStep>(logger_));
    // Q3 damage + pickups + ammo
    registry->RegisterStep(std::make_shared<WorkflowQ3AmmoInitStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowQ3DamageApplyStep>(logger_));
    registry->RegisterStep(std::make_shared<WorkflowQ3BotsDamageStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowQ3PlayerDeathCheckStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowQ3PlayerRespawnStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowQ3PickupsTouchStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowQ3PickupsRespawnStep>(logger_));
    // Q3 movers + triggers + nav
    registry->RegisterStep(std::make_shared<WorkflowQ3MoversInitStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowQ3MoversUpdateStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowQ3TriggersCheckStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowQ3TriggersApplyStep>(logger_));
    ...
    registry->RegisterStep(
        std::make_shared<WorkflowGeometryCreatePlaneStep>(logger_));
    count += 1;

    // ── Compute (tessellation) ────────────────────────────────
    registry->RegisterStep(
        std::make_shared<WorkflowComputeTessellateStep>(logger_));
    count += 1;

    // ── Camera ─────────────────────────────────────────────────
    registry->RegisterStep(std::make_shared<WorkflowCameraSetupStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowCameraFpsUpdateStep>(logger_));
    ...
    registry->RegisterStep(
        std::make_shared<WorkflowCameraSetPoseStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowCameraTeleportStep>(logger_));
    count += 6;

    // ── Physics ────────────────────────────────────────────────
    registry->RegisterStep(
        std::make_shared<WorkflowPhysicsWorldCreateStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowPhysicsBodyAddStep>(logger_));
    registry->RegisterStep(std::make_shared<WorkflowPhysicsStepStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowPhysicsFpsMoveStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowPhysicsSyncTransformsStep>(logger_));
    count += 5;

    // ── Input (logger-only) ────────────────────────────────────
    registry->RegisterStep(std::make_shared<WorkflowInputPollStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowInputMouseGrabStep>(logger_));
    registry->RegisterStep(std::make_shared<WorkflowInputPollAllStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowInputKeyboardPollStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowInputAxisCombineStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowInputButtonCombineStep>(logger_));
    count += 3;

    // ── Input (service-dependent, nullptr until wired) ─────────
    std::shared_ptr<IInputService> inputSvc = nullptr;
    registry->RegisterStep(
        std::make_shared<WorkflowInputKeyPressedStep>(inputSvc, logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowInputGamepadAxisStep>(inputSvc, logger_));
    registry->RegisterStep(
    ...
    registry->RegisterStep(
        std::make_shared<WorkflowInputMouseButtonPressedStep>(inputSvc,
                                                              logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowInputMousePositionStep>(inputSvc, logger_));
    count += 5;

    // ── Audio (service-dependent, nullptr until wired) ─────────
    std::shared_ptr<IAudioService> audioSvc = nullptr;
    registry->RegisterStep(
        std::make_shared<WorkflowAudioPauseStep>(audioSvc, logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowAudioPlayStep>(audioSvc, logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowAudioResumeStep>(audioSvc, logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowAudioSeekStep>(audioSvc, logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowAudioSetLoopingStep>(audioSvc, logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowAudioSetVolumeStep>(audioSvc, logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowAudioStopStep>(audioSvc, logger_));
    count += 7;

    // ── Control structures (need registry) ─────────────────────
    registry->RegisterStep(
        std::make_shared<WorkflowControlForEachStep>(logger_, registry));
    registry->RegisterStep(
        std::make_shared<WorkflowControlIfElseStep>(logger_, registry));
    registry->RegisterStep(
        std::make_shared<WorkflowControlSwitchStep>(logger_, registry));
    registry->RegisterStep(
        std::make_shared<WorkflowTryCatchStep>(logger_, registry));
    count += 4;
    ...
    registry->RegisterStep(
        std::make_shared<WorkflowListFilterEqualsStep>(logger_));
    ...
    registry->RegisterStep(
        std::make_shared<WorkflowListReduceMaxStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowListReduceMinStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowListReduceSumStep>(logger_));
    count += 11;
    ...
    registry->RegisterStep(
        std::make_shared<WorkflowParticleUpdateStep>(logger_));
    count += 2;

    // ── String ─────────────────────────────────────────────────
    registry->RegisterStep(std::make_shared<WorkflowStringConcatStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowStringContainsStep>(logger_));
    ...
    registry->RegisterStep(
        std::make_shared<WorkflowStringReplaceStep>(logger_));
    ...
    // ── Value ──────────────────────────────────────────────────
    registry->RegisterStep(
        std::make_shared<WorkflowValueAssertExistsStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowValueAssertTypeStep>(logger_));
    ...
    registry->RegisterStep(
        std::make_shared<WorkflowModelSetTransformStep>(logger_));
    count += 2;

    // ── Scene (service-dependent, nullptr until wired) ─────────
    std::shared_ptr<ISceneService> sceneSvc = nullptr;
    registry->RegisterStep(
        std::make_shared<WorkflowSceneCreateStep>(sceneSvc, logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowSceneLoadStep>(sceneSvc, logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowSceneUpdateStep>(sceneSvc, logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowSceneClearStep>(sceneSvc, logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowSceneSetActiveStep>(sceneSvc, logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowSceneAddGeometryStep>(sceneSvc, logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowSceneRemoveGeometryStep>(sceneSvc, logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowSceneGetBoundsStep>(sceneSvc, logger_));
    count += 8;

    // ── Camera (service-dependent, nullptr until wired) ────────
    std::shared_ptr<IConfigService> configSvc = nullptr;
    registry->RegisterStep(
        std::make_shared<WorkflowCameraBuildViewStateStep>(configSvc, logger_));
    count += 1;

    // ── Cmdline / Data / Network / State (logger-only) ──────────
    registry->RegisterStep(std::make_shared<WorkflowCmdlineArgsStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowDataDeserializeStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowDataSerializeStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowNetworkConnectStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowNetworkReceiveStep>(logger_));
    ...
    registry->RegisterStep(
        std::make_shared<WorkflowGraphicsInitDeviceStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowGraphicsInitSwapchainStep>(logger_));
    count += 2;

    // ── Media (service-dependent, nullptr until wired) ────────
    registry->RegisterStep(
        std::make_shared<WorkflowMediaCatalogScanStep>(configSvc, logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowMediaItemSelectStep>(audioSvc, logger_));
    count += 2;

    // ── Package shader loader ─────────────────────────────────
    registry->RegisterStep(std::make_shared<WorkflowPackageShaderLoaderStep>(
        logger_, "", std::filesystem::path{}));
    count += 1;
    ...
    registry->RegisterStep(
        std::make_shared<WorkflowShaderBuiltinConstantColorStep>(logger_,
                                                                 graphicsSvc));
    registry->RegisterStep(std::make_shared<WorkflowShaderCompileStep>(
        logger_, shaderRegistry, graphicsSvc));
    // shader.system.initialize split into atomic steps; chain in order.
    registry->RegisterStep(
        std::make_shared<WorkflowShaderSystemInitializeStep>(logger_));
    registry->RegisterStep(
        std::make_shared<WorkflowShaderSystemGltfLoadStep>(logger_));
    registry->RegisterStep(std::make_shared<WorkflowShaderSystemCompileStep>(
        logger_, shaderRegistry, graphicsSvc));
    registry->RegisterStep(
        std::make_shared<WorkflowShaderSystemSetStep>(logger_, shaderRegistry));
    count += 6;
