 ...
 *
 * Parameters:
 *   shader_path          (string)  Path to shader binary (supports ~
 *                                  expansion)
 ...
 *   output_key           (string)  Context key to store the compiled
 *                                  SDL_GPUShader* (default:
 *                                  "compiled_shader")
 *
 * Requires in context:
 ...
 *   <output_key>_info -> nlohmann::json { format, stage, code_size,
 *                                        entrypoint }
 */
