...
/// Import an archetype's model and upload it to `device`.
///
/// Leaves `geometry` usable only on full success. Returns false, without
/// throwing, on any import, size or GPU failure.
