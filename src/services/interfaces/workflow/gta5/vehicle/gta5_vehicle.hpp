...
/// Build one into `car` without taking charge of it: the caller owns
/// what comes back and must hand it to DestroyGta5Vehicle in the end.
/// This is what lets the traffic keep a list of its own.
...
/// Copy one chassis transform, and its wheels', into the matrices they
/// draw with. The traffic drives its own cars and calls this itself.
