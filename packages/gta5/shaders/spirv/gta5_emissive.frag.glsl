...
// geometry: gta5_model.frag's lighting and shadow by day, plus the
// texture's own light after dark, faded in with gta5.time.night. The
// rest of this header is the model shader's.
//
